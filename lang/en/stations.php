...
return [
    ...
    'edit' => [
        'title' => 'Edit fuel station', 'eyebrow' => 'Selected fuel station',
        'form_eyebrow' => 'Station master data', 'heading' => 'Edit basic data',
        'description' => 'Edit approved basic data step by step. Status and directory link remain unchanged.',
        'general_description' => 'Review operator, brand and station names.',
        'address_description' => 'Only change the address when it belongs to this location. Coordinates will require verification.',
        'review_heading' => 'Review changes',
        'review_description' => 'Review the data before saving. Concurrent changes will not be overwritten.',
        'status_unchanged' => 'Status is not changed by this form.',
        'source_unchanged' => 'Source and directory link remain unchanged.',
    ],
    'link' => [
    ...
    'actions' => [
        ...
        'save_draft' => 'Save draft', 'edit' => 'Edit', 'save_changes' => 'Save changes', 'change_selection' => 'Change selection',
    ...
    'duplicate' => ['heading' => 'Possible duplicate station', 'description' => 'A station already exists at this address. Please provide a reason to continue.', 'edit_description' => 'Another station uses this address. Review and explain the intended duplicate.'],
    'validation' => [
        ...
        'duplicate_reason_required' => 'Please provide a reason.', 'edit_conflict' => 'This station was changed in the meantime. Reopen it to avoid overwriting newer data.',
        'postal_code' => 'Enter a valid five-digit postal code.',
        'radius' => 'Select an available search radius.',
    ],
    'notifications' => ['created' => 'Station draft saved.', 'updated' => 'Station basic data saved.', 'linked' => 'Station directory linked.'],
];
