...
} from '../../resources/js/german-iban.js';
...
test('berechnet und formatiert veröffentlichte deutsche Standardbeispiele', () => {
    ...
    assert.equal(normalizeAndValidateGermanIban('DE84 5306 0180 0300 2505 03'), 'DE84530601800300250503');
});
...
test('weist unvollständige oder nichtnumerische Eingaben ab', () => {
    ...
    assert.throws(() => normalizeAndValidateGermanIban('DE00 5306 0180 0300 2505 03'), /invalid_iban/);
});
